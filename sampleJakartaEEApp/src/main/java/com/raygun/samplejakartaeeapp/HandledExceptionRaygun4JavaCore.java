...
@Path("/handled-exception-core")
public class HandledExceptionRaygun4JavaCore {
    @GET
    @Produces("text/plain")
    public String get() {
        try {
            ...
            int raygunResponseCode = new RaygunClient(raygunApiKey).send(new Exception("Hello Raygun from a handled-by-core exception in Jakarta EE!"));
